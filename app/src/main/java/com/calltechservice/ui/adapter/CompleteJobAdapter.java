...
public class CompleteJobAdapter extends RecyclerView.Adapter<CompleteJobAdapter.MyViewHolder> {
    ...
    private List<CompleteJobResponse> onGoingJobResponseList;
    ...
    public CompleteJobAdapter(Context context, List<CompleteJobResponse> onGoingJobResponseList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        CompleteJobResponse model = onGoingJobResponseList.get(holder.getAdapterPosition());
