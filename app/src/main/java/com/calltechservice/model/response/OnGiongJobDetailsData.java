...
public class OnGiongJobDetailsData implements Parcelable {
    ...
    protected OnGiongJobDetailsData(Parcel in) {
        jobId = in.readString();
    ...
    public static final Creator<OnGiongJobDetailsData> CREATOR = new Creator<OnGiongJobDetailsData>() {
        @Override
        public OnGiongJobDetailsData createFromParcel(Parcel in) {
            return new OnGiongJobDetailsData(in);
        }

        @Override
        public OnGiongJobDetailsData[] newArray(int size) {
            return new OnGiongJobDetailsData[size];
        }
    };
